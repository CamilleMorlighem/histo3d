...
OGRLayer* SHPWriter::ExecuteSQL(const char* pszStatement,OGRGeometry* poSpatialFilter,const char* pszDialect){
	 return DataSource->ExecuteSQL(pszStatement,poSpatialFilter,pszDialect);
}
